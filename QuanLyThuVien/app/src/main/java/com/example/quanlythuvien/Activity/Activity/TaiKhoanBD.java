...
public class TaiKhoanBD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tai_khoan_bd);
        AnhXa();
        OnClickMenu();
        ActionBar();
        ...
        btnttk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(),TTTKBanDoc.class);
        ...
        btndmm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(),DoiMatKhauBD.class);
                startActivity(intent);
            }
        });
    ...
    private void AnhXa() {
        lnHome = findViewById(R.id.ln_home_bd);
        lnSearch = findViewById(R.id.ln_search_bd);
        tbTaiKhoan = findViewById(R.id.tbTaiKhoanBD);
        txtTen = findViewById(R.id.tvTenBanDoc);
        txtTaiKhoan = findViewById(R.id.tvTaiKhoanBD);
        btnttk = findViewById(R.id.btnthongtintkbd);
        btndmm = findViewById(R.id.btndoimatkhaubd);
        btndx = findViewById(R.id.btnDangXuatBD);
    }
}