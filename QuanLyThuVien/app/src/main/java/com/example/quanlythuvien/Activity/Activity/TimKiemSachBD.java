...
public class TimKiemSachBD extends AppCompatActivity {
    private LinearLayout lnHome,lnTaiKhoan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tim_kiem_sach_bd);
        AnhXa();
        OnClickMenu();
        ActionBar();
        GetDuLieuSach();
    ...
    private void AnhXa() {
        ...
        tbTimKiem = findViewById(R.id.tbTimKiemBD);
        recyclerViewSach = findViewById(R.id.recyclerTimKiemBD);
        ...
        edtSearch = findViewById(R.id.edtTimKiemBD);
    }
}