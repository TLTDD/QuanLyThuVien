...
public class DoiMatKhauBD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doi_mat_khau_bd);
        AnhXa();
        ActionToolbar();
        setBtnResetPass();
    }
    ...
    private void AnhXa(){
        editNewPass = findViewById(R.id.editNewPassBD);
        editOldPass = findViewById(R.id.editOldPassBD);
        btnResetPass = findViewById(R.id.btnResetPassBD);
        tbDMM = findViewById(R.id.tbDMMBD);
    }
}