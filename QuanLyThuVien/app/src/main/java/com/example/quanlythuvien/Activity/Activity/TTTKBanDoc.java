...
public class TTTKBanDoc extends AppCompatActivity {
    ...
    private void AnhXa() {
        tbTTTK = findViewById(R.id.tbTTTKBD);
        btnUpdate = findViewById(R.id.btnUpdatebd);
        edname = findViewById(R.id.edt_tk_htbd);
